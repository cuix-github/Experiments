...
TQuad roomPolys[numberOfPolys] = {
	{ { 4, 5, 6, 7 }, 10, 8, 216 * 220, { 0, -1, 0 }, &lightGrey, &black }, // ceiling
	{ { 0, 3, 2, 1 }, 10, 8, 216 * 220, { 0, 1, 0 }, &lightGrey, &black }, // floor
	{ { 0, 4, 7, 3 }, 10, 8, 216 * 220, { 1, 0, 0 }, &red, &black }, // left wall
	{ { 0, 1, 5, 4 }, 10, 8, 216 * 220, { 0, 0, 1 }, &lightGrey, &black }, // back wall
	{ { 2, 6, 5, 1 }, 10, 8, 216 * 220, { -1, 0, 0 }, &blue, &black }, // right wall
	{ { 2, 3, 7, 6 }, 10, 8, 216 * 220, { 0, 0, -1 }, &lightGrey, &black }, // ADDED front wall
	{ { 8, 9, 10, 11 }, 8, 1, 55 * 55, { 0, -1, 0 }, &black, &white }, // light
	{ { 16, 19, 18, 17 }, 10, 7, 60 * 50, { 0, 1, 0 }, &yellow, &black }, // box 1
	{ { 12, 13, 14, 15 }, 10, 7, 60 * 50, { 0, -1, 0 }, &yellow, &black },
	{ { 12, 15, 19, 16 }, 10, 7, 60 * 50, { -0.866, 0, -0.5 }, &yellow, &black },
	{ { 12, 16, 17, 13 }, 10, 7, 60 * 50, { 0.5, 0, -0.866 }, &yellow, &black },
	{ { 14, 13, 17, 18 }, 10, 7, 60 * 50, { 0.866, 0, 0.5 }, &yellow, &black },
	{ { 14, 18, 19, 15 }, 10, 7, 60 * 50, { -0.5, 0, 0.866 }, &yellow, &black },
	{ { 24, 27, 26, 25 }, 10, 7, 60 * 75, { 0, 1, 0 }, &lightGrey, &black }, // box 2
	{ { 20, 21, 22, 23 }, 10, 7, 60 * 75, { 0, -1, 0 }, &lightGrey, &black },
	{ { 20, 23, 27, 24 }, 10, 7, 60 * 75, { -0.866, 0, -0.5 }, &lightGrey, &black },
	{ { 20, 24, 25, 21 }, 10, 7, 60 * 75, { 0.5, 0, -0.866 }, &lightGrey, &black },
	{ { 22, 21, 25, 26 }, 10, 7, 60 * 75, { 0.866, 0, 0.5 }, &lightGrey, &black },
	{ { 22, 26, 27, 23 }, 10, 7, 60 * 75, { -0.5, 0, 0.866 }, &lightGrey, &black },
};
