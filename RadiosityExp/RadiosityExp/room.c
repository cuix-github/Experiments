...
/* input parameters */
TRadParams	params = {
	0.0000001,			/* convergence threshold */
...
TQuad roomPolys[numberOfPolys] = {
	{{4, 5, 6, 7}, 4, 8, 75*75, {0, -1, 0}, &lightGrey, &black},
	{{0, 3, 2, 1}, 4, 8, 75*75, {0, 1, 0}, &lightGrey, &black},
	{{0, 4, 7, 3}, 4, 8, 75*75, {1, 0, 0}, &red, &black},
	{{0, 1, 5, 4}, 4, 8, 75*75, {0, 0, 1}, &lightGrey, &black},
	{{2, 6, 5, 1}, 4, 8, 75*75, {-1, 0, 0}, &blue, &black},
	{{2, 3, 7, 6}, 4, 8, 75*75, {0, 0,-1}, &lightGrey, &black},
	{{8, 9, 10, 11}, 4, 8, 75*75, {0, -1, 0}, &black, &white},
	{{16, 19, 18, 17}, 4, 8, 75*75, {0, 1, 0}, &yellow, &black},
	{{12, 13, 14, 15}, 4, 8, 75*75, {0, -1, 0}, &yellow, &black},
	{{12, 15, 19, 16}, 4, 8, 75*75, {-0.866, 0, -0.5}, &yellow, &black},
	{{12, 16, 17, 13}, 4, 8, 75*75, {0.5, 0, -0.866}, &yellow, &black},
	{{14, 13, 17, 18}, 4, 8, 75*75, {0.866, 0, 0.5}, &yellow, &black},
	{{14, 18, 19, 15}, 4, 8, 75*75, {-0.5, 0, 0.866}, &yellow, &black},
	{{24, 27, 26, 25}, 4, 8, 75*75, {0, 1, 0}, &lightGrey, &black},
	{{20, 21, 22, 23}, 4, 8, 75*75, {0, -1, 0}, &lightGrey, &black},
	{{20, 23, 27, 24}, 4, 8, 75*75, {-0.866, 0, -0.5}, &lightGrey, &black},
	{{20, 24, 25, 21}, 4, 8, 75*75, {0.5, 0, -0.866}, &lightGrey, &black},
	{{22, 21, 25, 26}, 4, 8, 75*75, {0.866, 0, 0.5}, &lightGrey, &black},
	{{22, 26, 27, 23}, 4, 8, 75*75, {-0.5, 0, 0.866}, &lightGrey, &black},
};
